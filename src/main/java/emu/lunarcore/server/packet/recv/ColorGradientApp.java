...
public class ColorGradientApp extends Application {
    ...
    public void start(Stage primaryStage) {
        String[] colors = {"#ff69b4", "#ffd700", "#00ff00", "#00bfff", "#ff1493", "#ff8c00", "#7fff00", "#ff00ff", "#00ffff", "#8a2be2", "#dc143c", "#00ff7f", "#ff6347", "#4b0082", "#da70d6", "#ffdab9", "#ff0000", "#ff4500", "#ff8c00", "#ffa500", "#ffd700", "#ffff00", "#adff2f", "#7fff00", "#00ff00", "#00fa9a", "#00bfff", "#800080", "#ffa500", "#008000", "#800000", "#ffff00"};
        ...
        BackgroundImage backgroundImg = new BackgroundImage(new Image("https://api.cenguigui.cn/api/pic/"), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, BackgroundSize.DEFAULT);
